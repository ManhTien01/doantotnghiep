...
const createOrder = async (req, res, next) => {
    ...
    console.log("Razorpay keys:", config.razorpayKeyId, config.razorpaySecretKey);
    ...
    try {
      ...
      res.status(500).json({ success: false, message: "Failed to create Razorpay order", error: error?.error?.description || error.message });
    }
  };
